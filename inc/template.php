...
class AppTemplate
{
	...
	var $par_type, $par_by, $par_order, $par_parent, $par_num, $par_table, $par_start, $par_topic, $par_level, $par_day, $par_state,$par_area,$par_lang,$par_letter,$par_tag,$par_label,$par_maxpage,$par_starring,$par_similar,$par_from,$par_year,$par_end;
