...
function main()
{
	...
	$menudiy = "\"welcome\":{\"text\":\"欢迎页面\",\"url\":\"index.php?action=wel\"},\"leftdim_config\":{\"text\":\"快捷菜单配置\",\"url\":\"admin_leftdim.php\"},\"dh688\":{\"text\":\"推荐流量交换\",\"url\":\"http://www.688dh.com/daima.html\"},\"gg100\":{\"text\":\"推荐广告联盟\",\"url\":\"http://union.1000re.com/v/?s=1091\"},\"diym00\":{\"text\":\"\",\"url\":\"#\"}";
