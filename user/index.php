...
function upgradesave2()
{
	...
	$db->query( "UPDATE {pre}user set u_points=u_points-".$baoshi . ",u_flag=1,u_start='".date('Y-m-d H:i:s',time())."',u_end='".date('Y-m-d H:i:s',time()+ 24*60*60*$dn )."'  WHERE u_id =". $_SESSION["userid"]);
