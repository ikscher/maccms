...
class QqConnect
{
  ...
  function create_login_url()
  {
    ...
    . QQ_OAUTH_CONSUMER_KEY . "&redirect_uri=" . urlencode(QQ_CALLBACK_URL)
  ...
  function callback()
  {
    if($_REQUEST['state'] == $_SESSION['state']) //csrf
    {
      ...
      . "client_id=" . QQ_OAUTH_CONSUMER_KEY. "&redirect_uri=" . urlencode(QQ_CALLBACK_URL)
      . "&client_secret=" . QQ_OAUTH_CONSUMER_SECRET. "&code=" . $_REQUEST["code"];
